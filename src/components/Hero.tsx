      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center px-8 py-20 lg:flex-row">
        ...
        <div className="z-10 flex-1">
          ...
          <p className="mt-6 max-w-md text-lg text-slate-600">
            ...
            dalam satu platform. Gratis dan mudah dipahami.
          </p>
          ...
          <div className="mt-8 flex gap-4">
            ...
            <button
              onClick={handleLihatMateri}
              className="rounded-xl border-2 border-blue-600 px-7 py-4 font-semibold text-blue-600 transition hover:bg-blue-50"
            >
              Lihat Materi
            </button>
          </div>
